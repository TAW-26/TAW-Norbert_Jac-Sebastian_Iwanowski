            ...
            {isGenerating && (
                <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-md flex flex-col justify-center items-center p-6 text-center">
                    ...
                    <p className="text-lg lg:text-2xl font-medium text-gray-300 max-w-xl">
                        Przeszukujemy bazę atrakcji, analizujemy logistykę i układamy dla Ciebie idealny plan na każdy
                        dzień.
                        <br />
                        <span className="text-sm mt-4 block text-gray-500">
                            To zajmie kilkanaście sekund. Proszę nie odświeżać strony.
                        </span>
                    </p>
                </div>
            )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 flex-1 w-full relative z-10">
                            <div className="bg-white/40 dark:bg-black/20 rounded-3xl p-6 lg:p-8 flex flex-col items-center text-center shadow-inner border border-white/40 dark:border-white/5 justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-white/5">
                                <div className="w-full">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-black mb-4 text-black dark:text-white transition-colors duration-500">
                                        Gdzie chcesz dzisiaj polecieć?
                                    </h3>
                                    <input
                                        type="text"
                                        value={destination}
                            ...
                            <div className="bg-white/40 dark:bg-black/20 rounded-3xl p-6 lg:p-8 flex flex-col items-center text-center shadow-inner border border-white/40 dark:border-white/5 justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-white/5">
                                <div className="w-full flex flex-col items-center">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-black mb-2 text-black dark:text-white transition-colors duration-500 flex flex-col items-center justify-center gap-2">
                                        Kiedy jedziesz?
                                        <span className="text-sm bg-blue-500 dark:bg-orange-500 text-white px-3 py-1 rounded-full font-bold shadow-md">
                                            Dni: {calculatedDays}
                                        </span>
                                    </h3>
                                    ...
                                    <div className="flex flex-col gap-4 w-full mt-2">
                                        <div className="text-left w-full">
                                            <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1 pl-1">
                                                Wyjazd
                                            </label>
                                            <input
                                                type="date"
                            ...
                            <div className="bg-white/40 dark:bg-black/20 rounded-3xl p-6 lg:p-8 flex flex-col items-center text-center shadow-inner border border-white/40 dark:border-white/5 justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-white/5">
                                <div className="w-full">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-black mb-6 text-black dark:text-white transition-colors duration-500">
                                        Twój budżet.
                                    </h3>
                                    <div className="flex space-x-3 lg:space-x-4 justify-center mt-4">
                                        <button
                                            onClick={() => setBudget('Tani')}
                                            className={`w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-xl lg:rounded-2xl font-sans font-black text-xl lg:text-3xl transition-all duration-300 ${budget === 'Tani' ? 'bg-green-500 text-white scale-110 shadow-[0_0_15px_rgba(34,197,94,0.5)]' : 'bg-white dark:bg-[#333333] text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/30 shadow-sm'}`}
                                        >
                                            $
                                        </button>
                                        <button
                                            onClick={() => setBudget('Średni')}
                                            className={`w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-xl lg:rounded-2xl font-sans font-black text-xl lg:text-3xl transition-all duration-300 ${budget === 'Średni' || budget === 'medium' ? 'bg-orange-500 text-white scale-110 shadow-[0_0_15px_rgba(249,115,22,0.5)]' : 'bg-white dark:bg-[#333333] text-orange-600 dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-900/30 shadow-sm'}`}
                                        >
                                            $$
                                        </button>
                                        <button
                                            onClick={() => setBudget('Wysoki')}
                                            className={`w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-xl lg:rounded-2xl font-sans font-black text-xl lg:text-3xl transition-all duration-300 ${budget === 'Wysoki' ? 'bg-red-500 text-white scale-110 shadow-[0_0_15px_rgba(239,68,68,0.5)]' : 'bg-white dark:bg-[#333333] text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 shadow-sm'}`}
                                        >
                                            $$$
                                        </button>
                                    </div>
