...
const PlanTrip = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen w-full overflow-hidden">
            ...
            {/* ========================================== */}
            {/* SEKCJA GŁÓWNA - FORMULARZ PODRÓŻY          */}
            {/* ========================================== */}
                ...
                <RevealOnScroll>
                    <div className="bg-gray-200/80 dark:bg-[#262626]/95 backdrop-blur-lg w-full max-w-4xl lg:max-w-[1400px] lg:min-h-[65vh] flex flex-col justify-center p-8 py-16 lg:p-24 rounded-3xl lg:rounded-[3rem] shadow-2xl dark:shadow-white/10 border border-white/30 dark:border-white/10 relative transition-colors duration-500 overflow-visible">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 flex-1 w-full relative z-10">
                            ...
                            <div className="bg-white/40 dark:bg-black/20 rounded-3xl p-6 lg:p-8 flex flex-col items-center text-center shadow-inner border border-white/40 dark:border-white/5 justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-white/5">
                                <div className="w-full flex flex-col items-center">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-black mb-4 text-black dark:text-white transition-colors duration-500">Liczba dni.</h3>
                                    <input
                                        type="number"
                                        min="1"
                                        max="30"
                                        ...
                                        className="bg-white dark:bg-[#333333] border-2 border-transparent focus:border-blue-500 dark:focus:border-orange-500 rounded-xl px-4 py-3 text-lg lg:text-2xl font-bold focus:outline-none transition-colors duration-300 shadow-sm font-sans w-24 text-center text-gray-800 dark:text-white"
                                    />
                                </div>
                                <p className="font-sans text-sm md:text-base lg:text-lg font-medium text-gray-700 dark:text-gray-300 mt-6 lg:mt-8 transition-colors duration-500">
                                    Określ, na jak długo planujesz swoją przygodę (1–14 dni).
                                </p>
                            </div>
                            ...
                            <div className="bg-white/40 dark:bg-black/20 rounded-3xl p-6 lg:p-8 flex flex-col items-center text-center shadow-inner border border-white/40 dark:border-white/5 justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-white/5">
                                <div className="w-full">
                                    ...
                                    <div className="flex space-x-3 lg:space-x-4 justify-center mt-4">
                                        <button onClick={() => setBudget('cheap')} className={`w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-xl lg:rounded-2xl font-sans font-black text-xl lg:text-3xl transition-all duration-300 ${budget === 'cheap' ? 'bg-green-500 text-white scale-110 shadow-[0_0_15px_rgba(34,197,94,0.5)]' : 'bg-white dark:bg-[#333333] text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/30 shadow-sm'}`}>$</button>
                                        <button onClick={() => setBudget('medium')} className={`w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-xl lg:rounded-2xl font-sans font-black text-xl lg:text-3xl transition-all duration-300 ${budget === 'medium' ? 'bg-orange-500 text-white scale-110 shadow-[0_0_15px_rgba(249,115,22,0.5)]' : 'bg-white dark:bg-[#333333] text-orange-600 dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-900/30 shadow-sm'}`}>$$</button>
                                        <button onClick={() => setBudget('expensive')} className={`w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-xl lg:rounded-2xl font-sans font-black text-xl lg:text-3xl transition-all duration-300 ${budget === 'expensive' ? 'bg-red-500 text-white scale-110 shadow-[0_0_15px_rgba(239,68,68,0.5)]' : 'bg-white dark:bg-[#333333] text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 shadow-sm'}`}>$$$</button>
                                    </div>
                                </div>
                                <p className="font-sans text-sm md:text-base lg:text-lg font-medium text-gray-700 dark:text-gray-300 mt-6 lg:mt-8 transition-colors duration-500">
                                    Dopasujemy atrakcje do Twojego portfela (Oszczędnie, Standard, Premium).
                                </p>
                            </div>
                            ...
                            <div className="bg-white/40 dark:bg-black/20 rounded-3xl p-6 lg:p-8 flex flex-col items-center text-center shadow-inner border border-white/40 dark:border-white/5 justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-white/5">
                                ...
                                <p className="font-sans text-sm md:text-base lg:text-lg font-medium text-gray-700 dark:text-gray-300 mt-6 lg:mt-8 transition-colors duration-500">
                                    Wybierz co lubisz, a AI stworzy unikalną trasę specjalnie dla Ciebie.
                                </p>
                            </div>
                        ...
                        <div className="mt-12 lg:mt-16 flex justify-center relative z-10">
                            <button
                                onClick={() => navigate('/trip-result')}
                                className="bg-[#6584e0] dark:bg-orange-500 hover:bg-blue-600 dark:hover:bg-orange-600 text-white font-bold py-4 lg:py-6 px-8 sm:px-12 lg:px-32 text-xl sm:text-2xl lg:text-4xl rounded-2xl transition-all duration-300 shadow-xl dark:shadow-white/10 hover:scale-105 active:scale-95 w-full sm:w-auto"
                            >
                                Generuj moją podróż ✨
                            </button>
                        </div>
