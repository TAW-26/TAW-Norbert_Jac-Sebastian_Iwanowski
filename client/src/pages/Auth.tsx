...
import { Eye, EyeOff, Mail, Lock, LogIn, User, Calendar, Camera, ArrowLeft } from 'lucide-react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                ...
                setSuccessMessage('Konto zostało pomyślnie utworzone! Zaloguj się.');
                setIsLogin(true);
                setRegisterStep(1);
                setPassword('');
                setConfirmPassword('');
            ...
            <section className="flex-1 flex flex-col justify-center items-center px-4 sm:px-8 py-20 lg:py-40 min-h-[calc(100dvh-140px)] lg:min-h-screen relative transition-all duration-500">
                <RevealOnScroll>
                    <div className="bg-gray-200/80 dark:bg-[#262626]/95 backdrop-blur-lg w-full max-w-4xl lg:max-w-[1400px] lg:min-h-[65vh] rounded-3xl lg:rounded-[3rem] shadow-2xl dark:shadow-white/10 border border-white/30 dark:border-white/10 relative overflow-hidden flex flex-col lg:flex-row transition-colors duration-500">
                        ...
                        <div
                            className={`relative w-full grid grid-cols-1 lg:grid-cols-2 min-h-[680px] sm:min-h-[720px] lg:min-h-[70vh] transition-all duration-700 
                            ${!isLogin && registerStep === 2 ? 'opacity-0 blur-md pointer-events-none' : 'opacity-100'}`}
                        >
                            <div
                                className={`absolute lg:relative inset-0 w-full flex flex-col justify-center p-6 py-10 sm:p-10 lg:p-16 xl:p-20 transition-all duration-500 ease-in-out bg-transparent 
                            ...
                            >
                                ...
                                <form
                                    className="flex flex-col w-full max-w-md lg:max-w-lg mx-auto lg:mx-0"
                                ...
                                >
                                    <div className="flex flex-col mb-4">
                                        <label className="text-base sm:text-lg lg:text-xl font-black mb-2 text-black dark:text-white ml-1 flex items-center gap-2">
                                            <Mail className="w-4 h-4 lg:w-5 lg:h-5 text-blue-500 dark:text-orange-500" />{' '}
                                            E-mail
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    <div className="flex flex-col mb-4">
                                        <label className="text-base sm:text-lg lg:text-xl font-black mb-2 text-black dark:text-white ml-1 flex items-center gap-2">
                                            <Lock className="w-4 h-4 lg:w-5 lg:h-5 text-blue-500 dark:text-orange-500" />{' '}
                                            Hasło
                                        </label>
                                        <div className="relative flex items-center">
                                            ...
                                            <button
                                                ...
                                                className="absolute right-3 lg:right-4 text-gray-500 hover:text-blue-500 dark:hover:text-orange-500 transition-colors p-2"
                                            >
                                                {showPassword ? (
                                    ...
                                    {error && !isLogin && registerStep === 1 && (
                                        <div className="bg-red-500/10 border border-red-500 text-red-600 dark:text-red-400 font-sans text-sm font-bold p-3 rounded-xl mb-4 text-center">
                                            {error}
                                        </div>
                                    )}
                                    ...
                                    <button
                                        type="submit"
                                        className={`w-full bg-[#6584e0] dark:bg-orange-500 hover:bg-blue-600 dark:hover:bg-orange-600 text-white font-black py-4 lg:py-5 text-xl sm:text-2xl lg:text-3xl rounded-xl lg:rounded-2xl transition-all shadow-xl flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95`}
                                    >
                                        Dalej
                                    </button>
                                    ...
                                    <div className="flex items-start space-x-3 mt-4 ml-1">
                                        <input
                                            ...
                                            className="w-4 h-4 lg:w-5 lg:h-5 mt-1 accent-[#6584e0] dark:accent-orange-500 cursor-pointer"
                                        />
                                        <label
                                            htmlFor="terms"
                                            className="text-xs sm:text-sm lg:text-base font-bold text-gray-700 dark:text-gray-300 cursor-pointer leading-tight"
                                        >
                                    ...
                                    <div className="mt-6 lg:mt-8 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2">
                                        ...
                                        <button
                                            type="button"
                                            onClick={toggleMode}
                                            className="text-lg sm:text-xl lg:text-2xl font-bold text-[#6584e0] dark:text-orange-500 hover:underline transition"
                                        >
                                            Zaloguj się
                                        </button>
                                    </div>
                            ...
                            >
                                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-black mb-2 lg:mb-4 text-black dark:text-white tracking-tight text-center lg:text-left transition-colors">
                                    Witaj z powrotem!
                                </h2>
                                <p className="text-base sm:text-lg lg:text-xl font-sans font-medium text-gray-700 dark:text-gray-300 mb-8 lg:mb-10 text-center lg:text-left transition-colors">
                                    Zaloguj się, aby zarządzać swoimi podróżami.
                                </p>
                                ...
                                >
                                    {successMessage && isLogin && (
                                        <div className="bg-green-500/10 border border-green-500 text-green-600 dark:text-green-400 font-sans text-sm font-bold p-3 rounded-xl mb-4 text-center">
                                            {successMessage}
                                        </div>
                                    )}
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between items-center mb-8 lg:mb-10 px-1 mt-2 gap-4 sm:gap-0">
                                        <div className="flex items-center space-x-2 lg:space-x-3 w-full sm:w-auto justify-center sm:justify-start">
                                            <input
                                                type="checkbox"
                                                id="rememberMe"
                                                className="w-4 h-4 lg:w-5 lg:h-5 accent-blue-500 dark:accent-orange-500 cursor-pointer"
                                            />
                                            <label
                                                htmlFor="rememberMe"
                                                className="text-xs sm:text-sm lg:text-base font-bold text-gray-700 dark:text-gray-300 cursor-pointer"
                                            >
                                                Zapamiętaj mnie
                                            </label>
                                        </div>
                                        <a
                                            href="#"
                                            className="text-xs sm:text-sm lg:text-base font-bold text-blue-500 dark:text-orange-500 hover:underline transition w-full sm:w-auto text-center sm:text-right"
                                        >
                                            Nie pamiętasz hasła?
                                        </a>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className={`w-full bg-[#6584e0] dark:bg-orange-500 hover:bg-blue-600 dark:hover:bg-orange-600 text-white font-black py-4 lg:py-5 text-xl sm:text-2xl lg:text-3xl rounded-xl lg:rounded-2xl transition-all shadow-xl flex items-center justify-center gap-3 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:scale-[1.02] active:scale-95'}`}
                                    >
                                    ...
                                    <div className="mt-8 lg:mt-10 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2">
                                        ...
                                        <button
                                            type="button"
                                            onClick={toggleMode}
                                            className="text-lg lg:text-xl font-sans font-bold text-blue-500 dark:text-orange-500 hover:underline transition"
                                        >
                                            Zarejestruj się!
                                        </button>
                                    </div>
                        ...
                        <div
                            className={`absolute inset-0 z-30 flex flex-col justify-center items-center p-6 sm:p-10 lg:p-16 xl:p-20 transition-all duration-700 ease-in-out bg-transparent
                        ...
                        >
                            <div className="w-full max-w-2xl text-center flex flex-col items-center">
                                <button
                                    ...
                                    className="flex items-center gap-2 text-gray-500 hover:text-blue-500 dark:hover:text-orange-500 font-bold mb-6 transition self-start lg:self-center bg-white/40 dark:bg-black/20 px-4 py-2 rounded-xl"
                                >
                                ...
                                <form className="flex flex-col w-full max-w-md mx-auto" onSubmit={handleSubmit}>
                                    <div className="flex flex-col items-center mb-6">
                                        ...
                                        <span className="text-sm lg:text-base font-bold mt-3 text-gray-600 dark:text-gray-400">
                                            Dodaj zdjęcie profilowe (opcjonalnie)
                                        </span>
                                        <span className="text-xs lg:text-sm font-bold mt-1 text-gray-500 dark:text-gray-400 text-center px-4">
                                            Max. 5 MB (JPG, PNG, WEBP). <br /> Zdjęcie zostanie automatycznie
                                            dopasowane.
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex flex-col mb-4 text-left">
                                        <label className="text-base sm:text-lg lg:text-xl font-black mb-2 text-black dark:text-white ml-1 flex items-center gap-2">
                                            <User className="w-4 h-4 lg:w-5 lg:h-5 text-blue-500 dark:text-orange-500" />{' '}
                                            Unikalny Nick
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="flex flex-col mb-8 text-left">
                                        <label className="text-base sm:text-lg lg:text-xl font-black mb-2 text-black dark:text-white ml-1 flex items-center gap-2">
                                            <Calendar className="w-4 h-4 lg:w-5 lg:h-5 text-blue-500 dark:text-orange-500" />{' '}
                                            Data urodzenia
                                        </label>
                                        <input
                                            type="date"
